...
ActiveRecord::Schema[7.0].define(version: 2023_04_09_020549) do
  ...
  create_table "subfolders", force: :cascade do |t|
    ...
    t.index ["parent_id"], name: "index_subfolders_on_parent_id"
  end
  ...
  add_foreign_key "subfolders", "subfolders", column: "parent_id"
end
